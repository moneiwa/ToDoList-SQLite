...
onChange={(e) => setName(e.target.value)}className="todo-input" />

          <input type="text" placeholder="Task" value={todo} onChange={(e) => setTodo(e.target.value)} className="todo-input" />
